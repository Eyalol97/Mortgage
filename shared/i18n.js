(function () {
  const _t = {
    ...
    he: {
      ...
      'lp.card.bar.label': 'מילוי פרופיל',
      'lp.card.bar.value': '+תוצאות טובות יותר',
      'lp.card.cta':       '← שוחח עם הבוט',
      'lp.features.title': 'כלים מתקדמים להחלטות חכמות',
      'lp.features.sub':   'המודולים המיוחדים שלנו מספקים תובנות עמוקות לעזור לכם להבטיח את תנאי המשכנתא הטובים ביותר.',
      'lp.sim.title':      'סימולטור משכנתא',
      'lp.sim.desc':       'הפעלו תרחישים פיננסיים מדויקים. שנו ריביות, תקופות ומקדמות וראו את ההשפעה לטווח ארוך על העושר שלכם.',
      'lp.sim.bullet1':    'לוח סילוקין',
      'lp.sim.bullet2':    'השוואת תמהיל מסלולים',
      'lp.sim.bullet3':    'ייצוא סיכום PDF',
      'lp.sim.link':       '← פתח סימולטור',
      'lp.bot.title':      'יועץ משכנתא',
      'lp.bot.desc':       'קבלו תובנות מיידיות דרך היועץ המונחה ב-AI. שאלו שאלות מורכבות וקבלו הנחיות מותאמות לתקנות בנק ישראל.',
      'lp.bot.bullet1':    'זמין 24/7',
